...
from test_util_VnetandUnet_concat import test_all_case
#from networks.vnet_sdf import VNet
...
def test_calculate_metric():
    ...
    save_mode_path1 = os.path.join(snapshot_path, 'model1_iter_1000.pth')
    save_mode_path2 = os.path.join(snapshot_path, 'model2_iter_1000.pth')
