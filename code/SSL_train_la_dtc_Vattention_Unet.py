...
parser.add_argument('--exp', type=str,
                    default='LA/SSL_DTC_VattentionUNet_DecModi_consis0.2', help='model_name')
...
if __name__ == "__main__":
    ...
    def create_model(ema=False):
        # Network definition
        model = Vattention_Unet(n_channels=1, n_classes=num_classes-1,
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            supervised_loss = loss_seg_dice + loss_seg + args.beta * loss_sdf
            consistency_weight = get_current_consistency_weight(iter_num//150)

            loss = supervised_loss + consistency_weight *(0.2) * consistency_loss
