...
if __name__ == "__main__":
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            CTG_loss = torch.mean((dis_to_mask[:labeled_bs] - label_batch[:labeled_bs]) ** 2)          #supervised
            supervised_loss = loss_seg_dice + args.beta * loss_sdf + args.beta * CTG_loss
