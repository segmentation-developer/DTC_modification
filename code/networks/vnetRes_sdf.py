...
class VNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False, has_residual=False):
        ...
        self.block_one = ResidualConvBlock(2, n_channels, n_filters, normalization=normalization)
        ...
        self.block_nine = ResidualConvBlock(2, n_filters, n_filters, normalization=normalization)
